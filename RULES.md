...
| R3 | The participant's fork is the repository used for development and final submission.                         | Participant responsibility                                      |
| R4 | All code commits forming the Round 2 submission must be made during the **authorised build phase**.         | Repository history / evaluation                                 |
...
| R7 | Do not modify, delete or interfere with the organiser's official repository or another participant's work.  | Participant responsibility                                      |
...
The official repository, sample data and top-level documentation are provided as reference resources. Build your solution in **your own fork**.

If you find an issue or contradiction in the shared documentation or data, raise it with the organisers rather than silently changing the official repository.
